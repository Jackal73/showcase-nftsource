    ...
    <div className={`min-h-screen ${styles.section}
      ...
      <div className={`flex items-center
        ...
        <div className={`${styles.descDiv}
          ${reverse ? styles.descDivReverse : styles.descDivClass}${reverse ? " fadeRightMini" : " fadeLeftMini"} ${reverse ? styles.textRight : styles.textLeft}`}>
        ...
        <div className={`flex-1 ${styles.flexCenter} p-8 sm:px-0`}>
          <img src={mockupImg} className={`${reverse ? " fadeLeftMini" : " fadeRightMini"} ${styles.sectionImg}`} alt="mockup" />
        </div>
      </div>
    </div>
  );
